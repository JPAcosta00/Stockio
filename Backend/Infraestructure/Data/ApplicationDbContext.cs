...
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(u => u.TenantId).HasColumnType("char(36)");
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.Property(p => p.TenantId).HasColumnType("char(36)");
        ...
        modelBuilder.Entity<PurchaseInvoice>(entity =>
        {
            ...
            entity.Property(e => e.TenantId).HasColumnType("char(36)");
            entity.Property(e => e.ProviderId).HasColumnType("char(36)");
        ...
        modelBuilder.Entity<PurchaseInvoiceDetail>(entity =>
        {
            ...
            entity.Property(d => d.Id).HasColumnType("char(36)");
            entity.Property(d => d.PurchaseInvoiceId).HasColumnType("char(36)");
            entity.Property(d => d.ProductId).HasColumnType("char(36)");
        ...
        modelBuilder.Entity<Caja>(entity =>
        {
            ...
            entity.Property(c => c.TenantId).HasColumnType("char(36)");
        ...
        modelBuilder.Entity<MovimientoCaja>(entity => {
            ...
            entity.Property(m => m.Id).HasColumnType("char(36)");
            entity.Property(m => m.CajaId).HasColumnType("char(36)");
            entity.Property(m => m.VentaId).HasColumnType("char(36)").IsRequired(false);
        ...
        modelBuilder.Entity<Sale>(entity =>
        {
            ...
            entity.Property(s => s.Id).HasColumnType("char(36)");
            entity.Property(s => s.TenantId).HasColumnType("char(36)");
        ...
        modelBuilder.Entity<SaleDetail>(entity =>
        {
            ...
            entity.Property(sd => sd.Id).HasColumnType("char(36)");
            entity.Property(sd => sd.SaleId).HasColumnType("char(36)");
            entity.Property(sd => sd.ProductId).HasColumnType("char(36)");
