...
{
    Task<IEnumerable<ProductResponseDto>> SearchProductsAsync(string? query, Guid tenantId, Guid? providerId = null, string? period = null, bool isCriticalStock = false, string? categoriaStr = null);    
