        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div className="flex justify-end space-x-2.5 pt-4 mt-2 border-t border-zinc-800">
            <button
              type="button"
              onClick={onClose}
              className="bg-zinc-800 hover:bg-zinc-700 text-zinc-300 px-5 py-2.5 rounded-xl text-sm font-bold transition-colors shadow-sm"
            >
            ...
            {mode !== 'view' && (
              <button
                type="submit"
                className="bg-gradient-to-r from-[#5BA535] to-[#1C562A] hover:opacity-90 text-white px-5 py-2.5 rounded-xl text-sm font-bold transition-all shadow-md shadow-[#1C562A]/30"
              >
                Guardar Cambios
              </button>
            )}
